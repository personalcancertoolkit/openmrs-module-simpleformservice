 ...
 */
package org.openmrs.module.simpleformservice.web.filter;
        ...
        implements Filter
{
    ...
    {
        log.debug( "Initializing Simple Form Service WS Authorization filter" );
    }
    ...
    public void destroy()
    {
        log.debug( "Destroying Simple Form Service WS Authorization filter" );
    }
